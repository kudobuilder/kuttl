...
func (in *AnyAllExpressions) DeepCopyInto(out *AnyAllExpressions) {
	*out = *in
	if in.Any != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AnyAllExpressions.
func (in *AnyAllExpressions) DeepCopy() *AnyAllExpressions {
	if in == nil {
		return nil
	}
	out := new(AnyAllExpressions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TestAssert) DeepCopyInto(out *TestAssert) {
	*out = *in
	...
	in.AssertExpressions.DeepCopyInto(&out.AssertExpressions)
	return
}
