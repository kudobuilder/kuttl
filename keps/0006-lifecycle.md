...
**note:** there could be value in a before / after activity assertion.  This would allow for an assert to wait on to be true after a command was invoked but before a test started (this woudl ensure that a CRD is present prior to test execution).
